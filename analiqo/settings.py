...
SECRET_KEY = 'django-insecure-a9sd87fyas98d7fyasd87fyasd87fyasd87fyasd'
...
WSGI_APPLICATION = 'analiqo.wsgi.application'
...
LOGIN_URL = 'account_login'  # Changed from 'accounts:login' to use django-allauth's URL name
